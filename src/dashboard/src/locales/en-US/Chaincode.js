export default {
  ...
  'app.chainCode.form.install.peers': 'Peers',
  'app.chainCode.form.install.checkPeers': 'Please select peers',
  ...
  'app.chainCode.table.operate.interact': 'Interact',
  'app.chainCode.form.transact.header.title': 'Interact with Chaincode',
  'app.chainCode.form.transact.execute': 'Execute',
  'app.chainCode.form.transact.action': 'Action Type',
  'app.chainCode.form.transact.function': 'Function Name',
  'app.chainCode.form.transact.checkFunction': 'Please enter the function name',
  'app.chainCode.form.transact.arguments': 'Arguments',
  'app.chainCode.form.transact.checkArgument': 'Please input argument or delete this field',
  'app.chainCode.form.transact.addArgument': 'Add Argument',
  'app.chainCode.form.transact.result': 'Execution Result',
  'app.chainCode.form.transact.success': 'Transaction executed successfully',
};
